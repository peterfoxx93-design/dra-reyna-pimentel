        ...
        <div className="grid md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-teal-50 rounded-2xl p-6">
              ...
              <p className="text-gray-600">C/ Amalio Alonzo #24, Nagua</p>
            </div>
            <div className="bg-teal-50 rounded-2xl p-6">
              <h3 className="font-semibold text-lg mb-1">🕐 Horarios</h3>
              <p className="text-gray-600">Lun - Vie: 8:00 AM — 5:00 PM</p>
              <p className="text-gray-600">Sáb: 8:00 AM — 1:00 PM</p>
            </div>
            <a
              href="tel:+18095847033"
              className="flex items-center gap-3 bg-white border-2 border-teal-500 text-teal-700 font-semibold rounded-full px-6 py-3 hover:bg-teal-50 transition-all"
            >
              <Phone className="w-5 h-5" /> Llámanos: (809) 584-7033
            </a>
            <a
              href="https://wa.me/18095847033?text=Hola%2C%20quisiera%20agendar%20una%20cita"
              target="_blank"
              className="flex items-center justify-center gap-2 bg-green-500 text-white font-semibold rounded-full px-6 py-3 hover:bg-green-600 transition-all"
            >
